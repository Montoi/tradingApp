...
- ¡IDENTIFICACIÓN DEL ACTIVO!: Si el nombre del activo (ticker) está recortado o no se ve en pantalla, DEDÚCELO basándote en el nivel de precios actual. (Ejemplo: Si el precio es ~70,000 es BTC, si es ~2,400-2,500 es ORO XAU/USD, si es ~4,000 es ETH o SP500, etc.). Nunca asumas que es BTC si el precio no coincide lógicamente con BTC.
